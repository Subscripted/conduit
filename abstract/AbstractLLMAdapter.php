 ...
 *
 * The endpoints catch the RuntimeException thrown here in call() and return
...
abstract class AbstractLLMAdapter implements LLMAdapter
{
     ...
     * @throws \RuntimeException On cURL errors or when an HTTP error is not (or no longer) retried.
     */
